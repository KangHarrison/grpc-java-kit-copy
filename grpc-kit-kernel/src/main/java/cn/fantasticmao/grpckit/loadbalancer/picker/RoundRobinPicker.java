 ...
 * @since 2022/4/21
 */
public class RoundRobinPicker extends AbstractWeightPicker {

    private static final Logger LOGGER = LoggerFactory.getLogger(RoundRobinPicker.class);
    /**
    ...
    private static final AtomicIntegerFieldUpdater<RoundRobinPicker> INDEX_UPDATER =
        AtomicIntegerFieldUpdater.newUpdater(RoundRobinPicker.class, "robinIndex");
